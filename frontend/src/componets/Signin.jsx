    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 via-white to-black/10 pt-8 pb-12">
              ...
              <div className="w-full max-w-md bg-white/80 backdrop-blur-md shadow-xl rounded-2xl p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-yellow-600 mt-2">
                    {" "}
                    Create your account and start your journey with Dhiman Motors.
                  </p>{" "}
                </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <button
            ...
            className="w-full bg-black hover:bg-gray-700 text-white py-3 rounded-lg font-semibold transition duration-200"
          >
        ...
        {/* Google Sign In */}
        <button className="w-full border border-gray-300 py-3 rounded-lg flex items-center justify-center gap-3 hover:bg-gray-100 transition duration-200">
          <FcGoogle size={24} />
